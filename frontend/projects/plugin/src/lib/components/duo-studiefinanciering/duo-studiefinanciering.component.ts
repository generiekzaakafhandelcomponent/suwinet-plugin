...
export class DuoStudiefinancieringComponent
    implements FunctionConfigurationComponent, OnInit, OnDestroy {
    @Input() save$: Observable<void>;
    @Input() disabled$: Observable<boolean>;
    @Input() pluginId: string;
    @Input() prefillConfiguration$: Observable<DUOStudiefinancieringInfoComponent>;
    @Output() valid: EventEmitter<boolean> = new EventEmitter<boolean>();
    @Output() configuration: EventEmitter<DUOStudiefinancieringInfoComponent> = new EventEmitter<DUOStudiefinancieringInfoComponent>();

    private saveSubscription!: Subscription;
    private readonly formValue$ = new BehaviorSubject<DUOStudiefinancieringInfoComponent | null>(null);
    ...
    private handleValid(formValue: DUOStudiefinancieringInfoComponent): void {
        const valid = !!(
            formValue.bsn &&
