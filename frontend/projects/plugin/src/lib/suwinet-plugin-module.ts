...
@NgModule({
    declarations: [
        ...
        RdwVoertuigComponent,
        SvbPersoonsInfoComponent,
        UwvInkomstenInfoComponent,
        BijstandsregelingenInfoComponent
    ],
    imports: [CommonModule, PluginTranslatePipeModule, FormModule, InputModule, FormsModule, CarbonMultiInputModule, ParagraphModule, SelectModule],
    exports: [
        SuwinetPluginConfigurationComponent,
        BrpPersoonInfoComponent,
        BrpPartnerInfoComponent,
