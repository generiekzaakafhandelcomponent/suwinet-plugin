...
internal class SuwinetRdwServiceTest : BaseTest() {
    ...
    @Test
    fun `retrieving voertuig bezit with 3 voertuigen - second details call kenteken not found`() {
        // given
        val bsn = "111111110"
        val kentekenMh74dz = "MH74DZ"
    ...
    @Test
    fun `happy flow retrieving voertuig bezit with 1 voertuig from RDW suwinet`() {
        // given
        val bsn = "444444440"
        val kenteken = "MH74DZ"
